...
.. note::
   ...
   * Workflows end with ``_wf``, and are generated by a function of the form
     ...
     :func:`~fmriprep.workflows.bold.base.init_bold_apply_wf` names the
...
:py:func:`~fmriprep.workflows.bold.base.init_bold_apply_wf`
...
.. workflow::
    ...
    with mock_config():
        ...
        wf = init_bold_apply_wf(bold_series=[str(bold_file)])
